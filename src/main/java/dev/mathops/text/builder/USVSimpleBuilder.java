...
/**
 * Provides methods to concatenate string representations of various primitive or object types to the superclass code
 * point sequence.
 */
public class USVSimpleBuilder extends USVBuilder {

    /**
     * Constructs a new {@code USVSimpleBuilder}.
     *
     * @param capacity the initial capacity to allocate for storage
     */
    protected USVSimpleBuilder(final int capacity) {
    ...
    public final void addString(final String value) {
        ...
        if (value == null) {
            addChars(CharSimpleBuilder.NULL);
        } else {
    ...
    public final void addBoolean(final boolean value) {
        ...
        addChars(value ? CharSimpleBuilder.TRUE : CharSimpleBuilder.FALSE);
    }
    ...
    public final void addln() {
        ...
        addChars(CharSimpleBuilder.CR_LF_CHARS);
    }
    ...
    public static String concat(final Object... args) {
        ...
        final USVSimpleBuilder builder = new USVSimpleBuilder(100);
