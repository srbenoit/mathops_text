...
/**
 * Supplements the methods of {@code USVSimpleBuilder} to add CRLF to the ends of lines.
 */
class USVLineBuilder extends USVSimpleBuilder {

    /**
     * Constructs a new {@code USVLineBuilder}.
     *
     * @param capacity the initial capacity to allocate for storage
     */
    USVLineBuilder(final int capacity) {
