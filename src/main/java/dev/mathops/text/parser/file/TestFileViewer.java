 ...
 * a {@code JScrollPane}.
 */
public class TestFileViewer implements Runnable {
    ...
    public void run() {
        ...
        if (chooser.showOpenDialog(null) == JFileChooser.APPROVE_OPTION) {
            ...
            final SourceFile source = new SourceFile(file, Charset.defaultCharset());
            ...
            final SourceFileSwingPanel panel = new SourceFileSwingPanel(source);
    ...
    public static void main(final String... args) {
        ...
        SwingUtilities.invokeLater(new TestFileViewer());
    }
}
