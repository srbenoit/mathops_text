...
/**
 * A position in a source file, specified by start, end, and current positions, where each is
 * defined by a line index and column index.
 */
public final class LineOrientedFilePosition {
    ...
    /**
     * Constructs a new {@code SourceFileRange}.
     *
     * @param theSource the source file
     */
    public LineOrientedFilePosition(final LineOrientedFile theSource) {
